...
class QualityProperty(Property):
    ...
    values_mapped = [
        MappedValue(source="200", readable="200 DPI", webapp="quality-200"),
        MappedValue(source="300", readable="300 DPI", webapp="quality-300"),
        MappedValue(source="400", readable="400 DPI", webapp="quality-400"),
        MappedValue(source="600", readable="600 DPI", webapp="quality-600"),
    ]
